...
int main()
{
    try
    {
        ...
        std::cout << "int3 = " << std::to_string( config.getInteger( "int3" ) ) << std::endl;
        ...
        std::cout << "uint3 = " << std::to_string( config.getUnsignedInteger( "uint3" ) ) << std::endl;
        std::cout << "long1 = " << std::to_string( config.getLong( "long1" ) ) << std::endl;
        std::cout << "long2 = " << std::to_string( config.getLong( "long2" ) ) << std::endl;
        std::cout << "long3 = " << std::to_string( config.getLong( "long3" ) ) << std::endl;
        ...
        std::cout << "ulong3 = " << std::to_string( config.getUnsignedLong( "ulong3" ) ) << std::endl;
        ...
        std::cout << "longlong3 = " << std::to_string( config.getLongLong( "longlong3" ) ) << std::endl;
        ...
        std::cout << "ulonglong3 = " << std::to_string( config.getUnsignedLongLong( "ulonglong3" ) ) << std::endl;
